...
| YC-02 | Sinh Test Case tự động và structured output | TC-GEN-004, TC-GEN-005, TC-GEN-006 | PASS - Unit/Regression Test; provider thật chưa xác nhận do API key local HTTP 401 |
...
| NC-03 | Structured Test Case generation | TC-GEN-004, TC-GEN-006 |
...
- Backend Unit Test: 73/73 PASS.
- Ruff check / format: PASS.
- Alembic: `0009_nc10_user_admin (head)`.
- GitHub Actions backend-quality: PASS.
- GitHub Actions frontend-quality: PASS.
