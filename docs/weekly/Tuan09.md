...
- Backend regression đạt 107 PASS.
...
1. DF-T09-01 - Celery async event-loop issue - Major - CLOSED.
2. DF-T09-02 - Integration/demo database isolation - Major - CLOSED.
3. DF-T09-03 - Requirement cũ không mở lại được từ UI - Minor - CLOSED.
...
- Backend full suite: 107 PASS, 1 warning.
- Integration: 15 PASS, 1 warning.
